# Gateway FE Deployment Flow

## Domain Mapping

- `staging` branch -> `https://testgateway.plxeditor.com/`
- `prod` branch -> `https://gateway.plxeditor.com/`

Production user entrypoint:

- `https://gateway.plxeditor.com/`
...
1. Sua code trong `/home/vpsroot/projects/frontend/gateway-fe`
...
10. QA tren `https://testgateway.plxeditor.com/`
...
15. Smoke test `https://gateway.plxeditor.com/`
...
- Khuyen nghi frontend goi API cung domain:
  - test: `/api/` -> `https://testgateway.plxeditor.com/api/`
  - prod: `/api/` -> `https://gateway.plxeditor.com/api/`
...
```bash
curl -I https://testgateway.plxeditor.com/
curl -I https://gateway.plxeditor.com/
```
